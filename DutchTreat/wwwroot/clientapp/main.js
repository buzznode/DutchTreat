...
function ProductList_li_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate2"]("", p_r33.title, ": ", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](2, 2, p_r33.price), "");
} }
class ProductList {
    constructor(data) {
        this.data = data;
...
module.exports = __webpack_require__(/*! D:\Development\dotnetcore\projects\DutchTreat\DutchTreat\ClientApp\main.ts */"./ClientApp/main.ts");
